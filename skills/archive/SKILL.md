...
**Announce at start:** "I'm using the archive skill to capture the architectural knowledge from this change."
...
**Called by:**
- `finishing-a-development-branch` (Option 5)
- User directly via `/archive`
