...
**Context:** This should be run in a dedicated worktree (created by brainstorming skill). The brainstorming skill creates a change directory at `changes/YYYY-MM-DD-<topic>/` with a `design.md` inside it.
